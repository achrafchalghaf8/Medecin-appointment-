...
<body>
<h3 align=center>
        <FONT size="8" align=center> <I><B style="color:#04AA6D">Liste des RDV</B></I></FONT>
    </h3><br><br>
...
<form name="f" action="Controlerdv.php"" method="GET">
    <br><br><br>
        <table align="center">
        <tr>
                
                <button type="submit" name="retour"><h3>Retourner</h3></button>
            </tr>
        </table>
